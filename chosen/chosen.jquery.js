...
(function () {
    ...
    Chosen = (function (_super) {
        ...
        _this = this;
            ...
            this.choices += 1;
            if (item.disabled) {
                html = '<li class="search-choice search-choice-disabled" id="' + choice_id + '"><span val="' + item.array_index + '" runat="server">' + item.html + '</span></li>';
            } else {
                html = '<li class="search-choice" id="' + choice_id + '"><span val="' + item.array_index + '" runat="server">' + item.html + '</span><a href="javascript:void(0)" class="search-choice-close" rel="' + item.array_index + '"></a></li>';
            }
